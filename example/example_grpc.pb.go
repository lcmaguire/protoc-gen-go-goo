...
type ExampleServiceClient interface {
	...
	UpdateExample(ctx context.Context, in *SearchRequest, opts ...grpc.CallOption) (*SearchResponse, error)
	DeleteExample(ctx context.Context, in *SearchRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *exampleServiceClient) UpdateExample(ctx context.Context, in *SearchRequest, opts ...grpc.CallOption) (*SearchResponse, error) {
	out := new(SearchResponse)
	err := c.cc.Invoke(ctx, "/tutorial.ExampleService/UpdateExample", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *exampleServiceClient) DeleteExample(ctx context.Context, in *SearchRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, "/tutorial.ExampleService/DeleteExample", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ExampleServiceServer interface {
	...
	UpdateExample(context.Context, *SearchRequest) (*SearchResponse, error)
	DeleteExample(context.Context, *SearchRequest) (*emptypb.Empty, error)
...
func _ExampleService_UpdateExample_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tutorial.ExampleService/UpdateExample",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ExampleServiceServer).UpdateExample(ctx, req.(*SearchRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _ExampleService_DeleteExample_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tutorial.ExampleService/DeleteExample",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ExampleServiceServer).DeleteExample(ctx, req.(*SearchRequest))
	}
	return interceptor(ctx, in, info, handler)
}
